...
public class viewFrame extends javax.swing.JPanel {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) viewTable.getModel();
        employeeData selectedEmployees = (employeeData) model.getValueAt(selectedRowIndex, 0);
        ...
        String CellNumber = String.valueOf(txtMobileno.getText()); 
        String Email = txtEmail.getText();
        String Team = txtGender.getText();
        String gender = txtGender.getText();
        
        
        
        
        selectedEmployees.setName(EmployeeName);
